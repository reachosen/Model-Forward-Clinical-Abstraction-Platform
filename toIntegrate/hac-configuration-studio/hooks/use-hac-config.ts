// React hooks for managing HAC configuration state
"use client"

import { useState, useEffect } from "react"
import { getHACConfig, saveHACConfig, previewHAC, publishHAC } from "@/lib/api/hac-config"
import type { HACConfig, PreviewResponse } from "@/lib/types/hac-config"
