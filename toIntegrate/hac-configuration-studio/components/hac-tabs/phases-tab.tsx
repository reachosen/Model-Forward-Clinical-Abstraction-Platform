...
import type { HACPhaseConfig, PhaseName } from "@/lib/types/hac-config"
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => onChange({ ...phase, timeout_ms: Number.parseInt(e.target.value) || 0 })}
                min="1000"
                step="1000"
              />
  ...
  return (
    <div className="space-y-6">
      <Alert>
        <AlertCircle className="h-4 w-4" />
        <AlertDescription>
          Configure which phases are available and how they behave. If Enrichment is disabled, Clinical Review auto-run
          must be off.
        </AlertDescription>
      </Alert>
