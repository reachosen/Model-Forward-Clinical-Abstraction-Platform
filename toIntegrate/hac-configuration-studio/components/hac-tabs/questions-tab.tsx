...
import type { HACQuestionsConfig } from "@/lib/types/hac-config"
  ...
  return (
    <div className="space-y-6">
      <Alert>
        ...
        <AlertDescription>
          Configure how suggested questions are generated in the Clinical Review phase. These questions help clinicians
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => onChange({ ...config, max_questions: Number.parseInt(e.target.value) || 1 })}
            />
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handlePriorityChange("high", Number.parseInt(e.target.value) || 0)}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handlePriorityChange("medium", Number.parseInt(e.target.value) || 0)}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handlePriorityChange("low", Number.parseInt(e.target.value) || 0)}
            />
          </div>
