...
import { recordContextMatrixUsage } from '../../EvalsFactory/refinery/observation/ObservationHooks';
...
/**
 * PHASE 1 STUB: SAFE Task Scorer
 * Currently returns a placeholder scorecard. 
 * Logic will be implemented in Phase 3.
 */
export function scoreTaskSafety(
  output: any,
  context: SAFEObserverContext
): SAFEScorecard {
  return {
    ...
    overall_label: 'Review', // Neutral default
