...
- S5 event_summary / summary_20_80 tasks must emphasize pediatric context
...
- `summary_20_80`: "first screen", "concise", "20/80 rule"
...
- Must inject:
  ...
  - `ranking_context.top_performer_benchmarks` → summary_20_80
...
- **Source**: `clinical-planner-cli/planner/validateV91.ts`
