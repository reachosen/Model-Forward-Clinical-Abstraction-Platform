...
- **Preventability_Detective_Metric**: 5-node graph (includes summary_20_80)
...
**Task Graph**: signal_enrichment → event_summary → [summary_20_80, followup_questions, clinical_review_plan]
