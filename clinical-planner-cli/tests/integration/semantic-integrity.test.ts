...
async function runSemanticValidator(plan: PlannerPlanV2): Promise<any> {
  ...
  if (q.summary_20_80 && (q.summary_20_80.patient_summary || q.summary_20_80.provider_summary)) {
    violations.push({ criterion: "1", description: "summary_20_80 contains content" });
  }
