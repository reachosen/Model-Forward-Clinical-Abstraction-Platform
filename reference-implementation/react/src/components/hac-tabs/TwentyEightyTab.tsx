...
import type { HAC2080Config } from '../../types/hac-config';
  ...
  const handleAddWeighting = () => {
    ...
    onChange({
      ...
      signal_weighting: {
        ...
        [upperKey]: parseFloat(newWeightingValue) || 1.0,
      },
    });
    setNewWeightingKey('');
  ...
  return (
    <div className="space-y-6">
      <Alert>
        ...
        <AlertDescription>
          These settings control the 20/80 summary panel in Clinical Review, determining which findings and signals are highlighted.
        </AlertDescription>
      </Alert>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => onChange({ ...config, max_findings: parseInt(e.target.value) || 1 })}
            />
